...
const Auth = () => {
    ...
    const inputStyles = "border border-gray-300 sm:text-sm text-black rounded:lg block w-full p-3 focus:outline-none";
    ...
    return <section className="container mx-auto">
        <div className="p-6 space-y-4 sm:p-8 w-80 md:w-[70%] mx-auto">
            <div className="flex mb-8 flex-col md:flex-row items-center justify-between">
                <h1 className="text-xl font-bold leading-tight trackong-tight md:text-2xl">
                    Create an Account
                </h1>
                <p>OR</p>
